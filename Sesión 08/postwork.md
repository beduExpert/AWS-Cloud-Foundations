...
![pw-ecs-ingress-to-clusters-01.png](pw-ecs-ingress-to-clusters-01.png)



2. Acceder a la parte de servicios y dar click en el servicio generado.

![pw-ecs-access-to-service-01.png](pw-ecs-access-to-service-01.png)



3. Dar click en la tarea

![pw-ecs-see-task-definition-01.png](pw-ecs-see-task-definition-01.png)



4. Dar click en el "Task role"

 ![pw-ecs-access-to-task-role-01.png](pw-ecs-access-to-task-role-01.png)


5. Eso abrirá la consola del servicio IAM posicionado directamente en el Rol. Dar clic en "Asociar políticas"

![pw-iam-see-task-execution-role-01.png](pw-iam-see-task-execution-role-01.png)
...
![pw-iam-add-sns-policy-01.png](pw-iam-add-sns-policy-01.png)


8. Listo, con esos pasos se ha dado capacidad para que los contenedores docker tengan acceso al servicio SNS.

![pw-iam-sns-role-added-01.png](pw-iam-sns-role-added-01.png)
...
![pw-goto-sns-aws-01.png](pw-goto-sns-aws-01.png)

2. Click en "Temas" (Topic):

![pw-sns-access-to-Topic-01.png](pw-sns-access-to-Topic-01.png)

3. Click en "Crear un tema"

![pw-sns-create-topic-02.png](pw-sns-create-topic-02.png)
...
![pw-sns-configure-topic-03.png](pw-sns-configure-topic-03.png)

5. El tópico o tema es generado. Click ahora en "Crear una nueva suscripción"

![pw-sns-topic-created-01.png](pw-sns-topic-created-01.png)
...
![pw-sns-subscribe-to-a-topic-01.png](pw-sns-subscribe-to-a-topic-01.png)


7. La suscripción es generada, dar click en el nombre del Tema:

![pw-sns-suscription-done-access-topic-01.png](pw-sns-suscription-done-access-topic-01.png)


8. Copiar el ARN del tópico, será usado en el siguiente paso.

![pw-sns-copy-arn-topic-01.png](pw-sns-copy-arn-topic-01.png)
...
![pw-ecs-access-to-task-definitions-01.png](pw-ecs-access-to-task-definitions-01.png)
...
![pw-ecs-update-service-new-revision-01.png](pw-ecs-update-service-new-revision-01.png)
...
![pw-create-task-execution-reconfig-01.png](pw-create-task-execution-reconfig-01.png)
...
![pw-ecs-task-definition-define-container-01.png](pw-ecs-task-definition-define-container-01.png)
...
![pw-create-task-definition-done-01.png](pw-create-task-definition-done-01.png)
...
![pw-ecs-update-new-task-01.png](pw-ecs-update-new-task-01.png)
...
![pw-ecs-service-new-service-01.png](pw-ecs-service-new-service-01.png)


8. No hay que modificar nada, se puede pasar al "next step"

![pw-ecs-service-redifine-01.png](pw-ecs-service-redifine-01.png)

9. Sejar la configuración como aparece en la pantalla, click en "next step".

![pw-ecs-click-third-service-01.png](pw-ecs-click-third-service-01.png)

10. Una vez hecho el review de los cambios se puede hacer click en "Update Services"

![pw-ecs-service-updating-last-step-01.png](pw-ecs-service-updating-last-step-01.png)
...
![pw-ecs-service-updating-01.png](pw-ecs-service-updating-01.png)
...
![pw-ecs-updating-service-02.png](pw-ecs-updating-service-02.png)

13. A continuación se ve como las tareas ejecutándose (a) ya son iguales a la definida en el servicio (a).

![pw-ecs-service-task-updated-01.png](pw-ecs-service-task-updated-01.png)
...
![pw-web-app-fill-form-01.png](pw-web-app-fill-form-01.png)

15. Un mensaje de registro exitoso se puede ver.

![pw-user-subcribed-created-01.png](pw-user-subcribed-created-01.png)

16. Y lo más importante, un SMS debe llegar al celular dado de alta al configurar el tópico en AWS SNS.

![pw-sms-sended-01-yay.jpg](pw-sms-sended-01-yay.jpg)
